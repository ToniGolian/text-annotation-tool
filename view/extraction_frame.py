...
class ExtractionFrame(tk.Frame):
    ...
    def _render(self) -> None:
        ...
        self.label_page_margins = tk.Label(self, text="Document type")
        self.label_page_margins.grid(
        ...
        self.radio_a4.grid(row=5, column=0, padx=10, pady=5, sticky='e')
        self.radio_brochure.grid(row=5, column=1, padx=10, pady=5, sticky='w')
        ...
        self.button_adopt_text.grid(
            row=7, column=0, columnspan=2, padx=20, pady=10, sticky='ew')
    ...
    def _on_button_pressed_extract_pages(self) -> None:
        ...
        """
        print("Extract pages button pressed.")
        self._controller.execute_command("extract_pdf")

    def _on_button_pressed_adopt_text(self) -> None:
        """
        Handler for the adopt text button. Invokes the controller's command to 
        adopt the extracted text.
        """
        print("Adopt text button pressed.")
        self._controller.execute_command("adopt_text")
